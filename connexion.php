...
<link rel="dns-prefetch" href="http://www.checkout.com/">
    ...
    <title>Connexion - MyStudies.com</title>
<meta name="description" content="Rejoignez la communaut&eacute; MyStudies.com et augmentez vos chances de r&eacute;ussites dans vos &eacute;tudes !">
...
<header >
                ...
                <div class="ml-2 content-header-controls d-flex align-items-center">
                    <div class="text-top-header top-header-right select-language ml-4 mr-4 ">
                        ...
                        <div class="dropdown dropleft drop-language">
                            <img src="imgs/cote-d-ivoire-flag-small.png" style="margin-top: -4px;" class="ml-2 icon-top-header" alt="">
    ...
    <div class="d-flex flex-column align-items-center">
        <img src="imgs/login-icon.png" class="" alt="">
        <h3 class="text-center font-weight-bolder mt-sm-3 mt-1 font-size-large"> Vous possédez déjà un compte sur MyStudies.com ?</h3>
    </div>
        <form method="POST" action="https://www.mystudies.com/login" accept-charset="UTF-8" class="pt-3 pt-sm-4 mb-sm-4 mb-2" enctype="multipart/form-data"><input name="_token" type="hidden" value="J836bzz4ZRGrsTGHzBlZf6PYHb9JVgZXGivpGTWD"> 
    ...
    <input name="cjs_ck" type="hidden" value=""> 
        ...
        <div class="col-lg-12">
            <div class="form-group row">
                ...
                <div class="col-lg-12"><input class="form-control input-medium required" name="email" type="email" value=""> 
                </div>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="form-group mb-4 row">
                ...
                <div class="col-lg-12"><input class="form-control input-medium" name="password" type="password" value=""> 
                </div>
            </div>
        </div>
        <div class="col-lg-12">
        ...
        <div class="col-lg-12">
                        <button class="btn mt-4 font-weight-bolder font-size-large float-left  btn-blue w-100">Connexion</button>
        </div>
    </div>

            <input type="hidden" name="previous" value="index.html">
    
    </form>
</div>
<div class="col-lg-7 px-4 px-sm-5 pb-4 pt-2 content-infos-order">
    <div class="d-flex flex-column mt-3 pt-2 align-items-center">
        <img src="imgs/register-icon.png" class="pt-1" alt="">
...
<div class="col-lg-12">
    ...
    <div class="col-lg-12">
        ...
        <div class="col-lg-12">
            <div class="d-flex flex-column align-items-center">
                                <button class="btn mt-4 font-weight-bolder font-size-large float-left btn-blue w-100">Créer un compte</button>
                <a href="devenir-tuteur-correcteur.html"
        ...
        <div class="row">
            ...
            <div class="col-12 mt-sm-0 mt-3 col-sm-3">
                ...
                <div class="d-flex flex-grow-1 justify-content-center justify-content-sm-start">
                    ...
                    <a href="#" target="_blank" class="ml-sm-3 ml-0"> <img src="imgs/icon-twitter-nl.png" style="margin-top:-1px;" class="" alt=""> </a>
